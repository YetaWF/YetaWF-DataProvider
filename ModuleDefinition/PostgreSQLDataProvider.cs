...
namespace YetaWF.DataProvider.PostgreSQL {
    ...
    internal class PostgreSQLDataProvider {
        ...
        internal class ModuleDefinitionDataProvider<KEY, TYPE> : PostgreSQLModuleObject<KEY, TYPE>, ModuleDefinitionDataProviderIOMode {
            ...
            public async Task<SerializableList<DesignedModule>> GetDesignedModulesAsync() {
                using (PostgreSQLSimpleObject<Guid, TempDesignedModule> dp = new PostgreSQLSimpleObject<Guid, TempDesignedModule>(Options)) {
