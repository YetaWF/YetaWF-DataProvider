...
namespace YetaWF.DataProvider.PostgreSQL {
    ...
    /// </summary>
    public partial class PostgreSQLSimple2IdentityObject<KEYTYPE, KEYTYPE2, OBJTYPE> : PostgreSQLSimpleIdentityObjectBase<KEYTYPE, KEYTYPE2, OBJTYPE> {
        ...
        /// </remarks>
        public PostgreSQLSimple2IdentityObject(Dictionary<string, object> options) : base(options, HasKey2: true) { }

    }
    /// <summary>
    /// This class implements access to objects (records), with one primary key and with an identity column.
    /// </summary>
    public partial class PostgreSQLSimpleIdentityObject<KEYTYPE, OBJTYPE> : PostgreSQLSimpleIdentityObjectBase<KEYTYPE, object, OBJTYPE> {
        ...
        /// Data providers are instantiated when the YetaWF.Core.DataProvider.DataProviderImpl.MakeDataProvider method is called, usually by an application data provider.
        /// </remarks>
        public PostgreSQLSimpleIdentityObject(Dictionary<string, object> options) : base(options) { }
    }
    ...
    /// </summary>
    public partial class PostgreSQLSimpleIdentityObjectBase<KEYTYPE, KEYTYPE2, OBJTYPE> : PostgreSQLSimpleObjectBase<KEYTYPE, KEYTYPE2, OBJTYPE>, IDataProviderIdentity<KEYTYPE, KEYTYPE2, OBJTYPE> {

        internal PostgreSQLSimpleIdentityObjectBase(Dictionary<string, object> options, bool HasKey2 = false) : base(options) {
